...
import fr.istic.projet.config.audit.AuditEventConverter;
import fr.istic.projet.domain.PersistentAuditEvent;
...
import static fr.istic.projet.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
